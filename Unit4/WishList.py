...
def wish_list(a_list, a_string, cost, budget) :
    for i in a_list:
        if i == a_string:
            if cost <= budget:
                return "You should buy a " + a_string + "!"
            else:
                return "You should save up for a " + a_string + "!"
    return "You probably don't want to buy a " + a_string + "."
