...
def select_a_show(minutes_remaining):
    if minutes_remaining > 100:
        return "Watch a movie!"
    elif minutes_remaining >= 46 and minutes_remaining <= 100:
        return "Watch a drama!"
    elif minutes_remaining >= 11 and minutes_remaining <= 45:
        return "Watch a comedy!"
    elif minutes_remaining >= 1 and minutes_remaining <= 10:
