...
if team_1_score > team_2_score:
    wonBy = team_1_score - team_2_score
    aStr = team_1 + " beat " + team_2 + " by " +str(wonBy)
elif team_2_score > team_1_score:
    wonBy = team_2_score - team_1_score
    aStr = team_2 + " beat "  + team_1 + " by " + str(wonBy) 
else:
    aStr = team_1 + " played " + team_2 + " and it was a tie"
print(aStr)
