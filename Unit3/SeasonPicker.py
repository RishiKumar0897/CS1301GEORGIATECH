...
def what_season(a_month,int_day):
    if (a_month == "April" or a_month == "May") or (a_month == "June" and int_day < 21) or (a_month == "March" and int_day >= 20): 
        return "Spring"
    if (a_month == "July" or a_month == "August") or (a_month == "September" and int_day < 22) or (a_month == "June" and int_day > 20):
        return "Summer"
    elif (a_month == "September" and int_day >= 22) or (a_month == "October" or a_month == "November") or (a_month == "December" and int_day < 21):
        return "Fall"
    else:
        return "Winter"
