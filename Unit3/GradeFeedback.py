...
modified_grade = grade + curve
if modified_grade > 100:
    modified_grade = 100

    
if modified_grade >= 90 and modified_grade <= 100:
    print("Congratulations! Your final grade is " + str(modified_grade) + ", an A.")
if modified_grade >= 80 and modified_grade < 90:
    print("Good job! Your final grade is " + str(modified_grade) + ", a B.")
if modified_grade >= 70 and modified_grade < 80:
    print("Not bad! Your final grade is " + str(modified_grade) + ", a C.")
if modified_grade >= 60 and modified_grade < 70:
    print("You passed! Your final grade is " + str(modified_grade) + ", a D.")
if modified_grade < 60:
    print("It's just one grade. Your final grade is " + str(modified_grade) + ", an F.")
