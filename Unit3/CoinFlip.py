...
for x in flips:
    if x == 'H':
        ...
        t_count += 1
if h_count > t_count:
    print(str(h_count) + " heads, " + str(t_count) + " tails. Heads wins.")
elif t_count > h_count:
    print(str(h_count) + " heads, " + str(t_count) + " tails. Tails wins.")
else:
    print(str(h_count) + " heads, " + str(t_count) + " tails. It's a tie.")