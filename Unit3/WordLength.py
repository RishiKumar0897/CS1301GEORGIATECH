...
def average_word_length(my_string):
  ...
  try:
    ...
    if (my_string[length_store-1]!="!" and my_string[length_store-1]!="?" and my_string[length_store-1]!="." and  my_string[length_store-1]!=" "):
      if  ( my_string[length_store-2]!=" " and my_string[length_store-2]!="!" and my_string[length_store-2]!="?" and my_string[length_store-2]!="."):
        word_counter+=1
    elif (my_string[length_store-1]=="!" or my_string[length_store-1]=="?" or my_string[length_store-1]=="." or my_string[length_store-1]==" ") and ( my_string[length_store-2]!=" " and my_string[length_store-2]!="."):
      word_counter+=1 
    ...
    for i in range(1,len(my_string)):
      ...
      elif my_string[i]!=" " and my_string[i-1]!=" ":
        word_counter+=0
      elif my_string[i] == " " and my_string[i-1]==" ":
  ...
  try:
    return letter_count/word_counter
