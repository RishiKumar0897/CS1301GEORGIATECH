...
true_amount = round(amount,2)
if (true_amount < goal):
    rounded_diff = round(goal - true_amount, 2)
    print("You'll fall short of your goal by " + str(rounded_diff))
else:
    rounded_diff = round(true_amount - goal, 2)
    print("You'll exceed your goal by " + str(rounded_diff))