...
def check_winner(board):
    ...
    # Check horizontal locations for "X" win
    for c in range(COLUMN_COUNT - 3):
        for r in range(ROW_COUNT):
            if board[r][c] == x and board[r][c+1] == x and \
            board[r][c+2] == x and board[r][c+3] == x:
                return "X"
            
    # Check horizontal locations for "O" win
            if board[r][c] == o and board[r][c+1] == o and \
            board[r][c+2] == o and board[r][c+3] == o:
                return "O"

    # Check vertical locations for "X" win
    for c in range(COLUMN_COUNT):
        for r in range(ROW_COUNT - 3):
            if board[r][c] == x and board[r+1][c] == x and \
            board[r+2][c] == x and board[r+3][c] == x:
                return "X"
            
    # Check vertical locations for "O" win
            if board[r][c] == o and board[r+1][c] == o and \
            board[r+2][c] == o and board[r+3][c] == o:
                return "O"
            
    # Check positively sloped diagonal locations for "X" win
    for c in range(COLUMN_COUNT - 3):
        for r in range(ROW_COUNT - 3):
            if board[r][c] == x and board[r+1][c+1] == x and \
            board[r+2][c+2] == x and board[r+3][c+3] == x:
                return "X"
    # Check positively sloped diagonal locations for "O" win
            if board[r][c] == o and board[r+1][c+1] == o and \
            board[r+2][c+2] == o and board[r+3][c+3] == o:
                return "O"
    # Check negatively sloped diagonal locations for "X" win
    for c in range(COLUMN_COUNT - 3):
        for r in range(3, ROW_COUNT):
            if board[r][c] == x and board[r-1][c+1] == x and \
            board[r-2][c+2] == x and board[r-3][c+3] == x:
                return "X"
    # Check negatively sloped diagonal locations for "O" win
            if board[r][c] == o and board[r-1][c+1] == o and \
            board[r-2][c+2] == o and board[r-3][c+3] == o:
                return "O"
