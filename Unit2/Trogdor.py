...
print("And: " + str((a == True and b == True)))
print("Or: " + str((a == True or b == True)))
print("Xor: " + str((a == True and b == False) or (a == False and b == True)))
print("Nand: " + str(not (a == True and b == True)))
print("Nor: " + str(not(a == True or b == True)))
print("Xnor: " + str(not(a == True and b == False) and not (a == False and b == True)))