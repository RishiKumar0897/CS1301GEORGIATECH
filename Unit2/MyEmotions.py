...
sad = hungry or tired
confused = (busy and not stressed) and (hungry or tired)
bored = not (busy and not stressed) and not (hungry or tired) and not busy
anxious = (not (busy and not stressed) and not (hungry or tired)) and stressed


print("Happy: " + str(happy))
print("Sad: " + str(sad))
print("Confused: " + str(confused))
print("Bored: " + str(bored))
print("Anxious: " + str(anxious))
