...
print("Subtotal: " + str((meal_cost)))
print("Tax: " + str((meal_cost*tax_rate)))
print("Tip: " + str((meal_cost * tip_rate)))
print("Total: " + str((meal_cost + (meal_cost*tax_rate) + (meal_cost * tip_rate))))