...
sum_2 = "The sum is " + str(mystery_value_1 + mystery_value_2)
difference = ", the difference is " + str(mystery_value_1 - mystery_value_2)
product = ", the product is " + str(mystery_value_1 * mystery_value_2)
quotient = ", and the quotient is " + str(mystery_value_1 / mystery_value_2)


print(sum_2 + difference + product + quotient + ".")