...
exam_day = exam  
sunny_day = (not exam and (sunny and ((sunblock and morning_classes) or night_classes)))
rainy_day = (not exam and raining and rain_jacket)  
snowy_day = (not exam and snowing and ((friends_are_going and fluffy_coat) or (snow_boots and fluffy_coat) or (really_want_to_go)))
                                                                                                    
should_go = exam_day or sunny_day or rainy_day or snowy_day
print("True or false: I should go to class:", should_go)
